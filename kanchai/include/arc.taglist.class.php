...
class TagList
{
    ...
    function GetPageListDM($list_len,$listitem="info,index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".$purl."/$prepagenum/' class='prev disable'>&lt;</a>";
            $indexpage="<a href='".$purl."/1/' style='border-radius: 8px;'>首页</a>";
            $endpage="<a href='".$purl."/$totalpage/' style='border-radius: 8px;'>末页</a>";
        }
        else
        {
            $indexpage="<a href='".$purl."/1/' style='border-radius: 8px;'>首页</a>";
        ...
        {
            $indexpage="<a href='".$purl."/1/' style='border-radius: 8px;'>首页</a>";
            $nextpage.="<a href='".$purl."/$nextpagenum/' class='next'>&gt;</a>";
            $endpage="<a href='".$purl."/$totalpage/' style='border-radius: 8px;'>末页</a>";
        }
        else
        {
