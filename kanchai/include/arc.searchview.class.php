...
class SearchView
{
    ...
    $searchtype='',$starttime=0,$upagesize=20,$kwtype=1,$mid=0)
    {
        ...
        $tempfile = $GLOBALS['cfg_basedir'].$GLOBALS['cfg_templets_dir']."/".$GLOBALS['cfg_df_style']."/search.html";
        if ( defined('DEDEMOB') )
        {
            $tempfile =str_replace('.html','_m.html',$tempfile);
        }
...
//        $infos = "<td>共找到<b>".$this->TotalResult."</b>条记录/最大显示<b>{$totalpage}</b>页 </td>\r\n";
        ...
        {
            $prepage.="<td width='50'><a href='javascript:void(0);'>上一页</a></td>\r\n";
            $indexpage="<td width='30'><a href='".$purl."PageNo=1'>首页</a></td>\r\n";
             $endpage="<td width='30'><a href='".$purl."PageNo=$totalpage'>末页</a></td>\r\n";
        }
        ...
        {
            $indexpage="<td width='30'><a href='".$purl."PageNo=1'>首页</a></td>\r\n";
            $nextpage.="<td width='50'><a href='javascript:void(0);'>下一页</a></td>\r\n";
            $endpage="<td width='30'><a href='".$purl."PageNo=$totalpage'>末页</a></td>\r\n";
        }
        ...
        for($j; $j<=$total_list; $j++)
        {
            if($j == $this->PageNo)
            {
                $listdd.= "<td><a href='javascript:void(0);' class='current'>$j&nbsp;</a></td>\r\n";
            }
            else
            {
