...
function lib_flink(&$ctag,&$refObj)
{
    ...
    $attlist="type|textall,row|24,titlelen|24,linktype|1,typeid|0,width|88,height|31";
...
EOT;
    ...
    while($dbrow=$dsql->GetObject())
    {
        ...
        {
            $link = "<a href='".$dbrow->url."' target='_blank'><img src='".$dbrow->logo."'  width='".$width."'  height='".$height."'  border='0'></a> ";
        }
        else
        {
            if($dbrow->logo=='')
